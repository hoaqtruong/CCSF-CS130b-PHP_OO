<?php
//This code I wrote the make_captcha function in class captcha and captchaController myself, most functions in captcha class are those that I am able to understand and make it works when reading the captcha code from
...
//	
	...
	public function __construct()
	{
		...
		// sanitize pathes
		$this->tempfolder = ROOT . '_tmp/';
		$this->tempfolder = str_replace(array('\\'), array('/'), $this->tempfolder);
		$this->TTF_file = ROOT . 'fonts/actionj.ttf'; 
