<?php
/**
  * PHP-Class hn_captcha Version 1.5.2, released 30-Apr-2009
  *
  * Version for PHP 5 !
  *
  * Author: Horst Nogajski, coding@nogajski.de
  *
  * $Id: hn_captcha.class.php5,v 1.8.2.3 2009/04/30 14:53:45 horst Exp $
  *
...
/**
  ...
  *
  *
  * changes in version 1.5.1:   (2007-January-28)
  *
  *   - changed the RegExp-Pattern in "get_gd_version",
  *     to match e.g. "bundled (2.0.28 compatible)" and also "2.0 or higher"
  *
  *____
  *
  *
  * changes in version 1.5.2:   (2009-April-30)
  *
  *   - fixed a Bug with visibility-scope: set the variable "$public_key" and the
  *     functions "get_filename_url" and "get_filename" from private to protected,
  *     to work correctly again when inherited from the class-extension hn_CAPTCHA_X1.
  *     ( thanks to Nicola Aitoro and Shaun Freeman )
  *
  *____
  *
  **/
